...
<Image src={giftsettingon} alt="Allow anyone to gift me works on" />
...
<Image src={treattags} alt="Additional Treat Tags" />
...
- To be explicit, please list "Treats" as part of your
  [**Do Not Wants**](/exchange/faq#what-are-do-not-wants-dnws).
...
<Image src={giftsettingoff} alt="Allow anyone to gift me works off" />
...
2. In the **Associations** section of the New Work make sure:
   - This year's collection is listed in the `Post to Collections / Challenges`
     box.
   - You list all the recipients who you'd like to receive the work as a treat
     ...
     You can use copy & paste to make sure you're gifting to the correct person
     in the correct exchange!
