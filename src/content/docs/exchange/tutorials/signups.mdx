...
[here](/exchange/intro#the-basics).
...
2.  **Relationships**
    ...
    content for. You must have at least one relationship per request. These tags
...
4.  **Letter/OC Info** (_Optional_)
    ...
    [On Exchange Letters](/exchange/tutorials/letters) for more information on
    exchange letters.
...
5.  **Prompt/DNWs**
    ...
    [FAQs - What Are Do Not Wants (DNWs)?](/exchange/faq#what-are-do-not-wants-dnws)
    for more info!
...
However, please keep in mind that due to the way AO3 enforces its minimum
...
3.  **More Info** (_Optional_)
    ...
    100% confidentiality or request that you not be matched.

    <Aside type="note" icon="document" title="New for 2025">

    Please be sure to provide _usernames_ of individuals you would not like to
    be matched with. We will no longer be honoring requests to not match based
    on specific prompt types since prompts are optional.
