...
[Treats & Treatless FAQ - How do I give a Treat?](/exchange/treats#how-do-i-give-a-treat)
...
<Image src={associations} alt="Associations" />
...
<Image src={assignments} alt="Assignments Link" />

3. Find your assignment for DA Polyshipping and click the `Fulfill` button on
   the right hand side of the screen.

<Image src={fulfillfromdash} alt="Fulfill Button" />
...
<Image src={myassignment} alt="My Assignment Link" />
...
<Image src={fulfillfromexchange} alt="Fulfill Button" />
