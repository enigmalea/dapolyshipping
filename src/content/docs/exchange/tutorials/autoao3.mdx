...
<Image src={scrape} alt="Re-scrape Button" />
...
<Image src={first50} alt="First 50 Requests" />

<Image src={allrequests} alt="All Requests" />
...
The most useful tab for finding specific requests is the **All** tab, but there
are several filters available which simply won't work for our exchange.

<Image src={whichfilters} alt="Which Filters to Use" />
...
<Image src={shipfilter} alt="Relationship Filter" />
...
<Image src={exactshipfilter} alt="Exact Relationship Filter using Quotes" />
...
<Image src={coffeeshopau} alt="Exact Coffee Shop AU" />

<Image src={promptsearch} alt="Coffee Shop AU" />
...
<Image src={freeformfilter} alt="Searching For Treats Types" />
...
version of your assigned recipients' requests or look for friends' sign-ups.
...
<Image src={usersearch} alt="User Search" />

This will pull every request from the user and display them below.

<Image src={usersearch1} alt="User Results" />
...
<Image src={tagsetfilter} alt="Tagset Filter" />
