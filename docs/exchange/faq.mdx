...
[Tutorials: How to Sign-Up](./tutorials/signups).
...
See [Treats & Treatless FAQ](./treats) for more information on
treats.

## I can't complete my assignment. What do I do? {#default}
...
4. **We review works for requested ships, Do Not Wants, and other content we may
   ...
   :::info Other Content We May Not Be Sure about
...
- force someone to accept your gift or comment
  ...
  Please see [Help! I didn't get a comment!](#no-comment) for more information.
...
## Help! I didn't get a comment! {#no-comment}
