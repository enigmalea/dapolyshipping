...
These instructions only deal with fulfilling your assigned request for the exchange. If you're looking for how to give a treat, please see [Treats & Treatless FAQ - How do I give a Treat?](/docs/exchange/treats#how-do-i-give-a-treat)
...
<img src={require('/img/tutorial/associations.png').default} alt="Associations" className="thumbnail"></img>
</a>
<p className="label">Associations: click to enlarge</p>
<p> </p>
...
<img src={require('/img/tutorial/assignments.png').default} alt="Assignments Link" className="thumbnail"></img>
</a>
<p className="label">Assignments Link: click to enlarge</p>
<p> </p>
...
<img src={require('/img/tutorial/fulfillfromdash.png').default} alt="FulFill Button" className="thumbnail"></img>
</a>
<p className="label">Fulfill Button: click to enlarge</p>
<p> </p>
...
<img src={require('/img/tutorial/myassignment.png').default} alt="My Assignment Link" className="thumbnail"></img>
</a>
<p className="label">My Assignment Link: click to enlarge</p>
<p> </p>
...
<img src={require('/img/tutorial/fulfillfromexchange.png').default} alt="FulFill Button" className="thumbnail"></img>
</a>
<p className="label">Fulfill Button: click to enlarge</p>
<p> </p>
...
- From `My Dashboard` on the left-hand sidebar click on `Statistics`. Your work will be listed on your stats page.
- From `My Works` on the top right click the `Works in Collections` button. This only works once your work has been approved and added to the exchange.
