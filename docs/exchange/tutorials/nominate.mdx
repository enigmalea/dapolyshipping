...
:::danger Dragon Age: The Veilguard Relationships

For this round, relationships which have the DA:V protagonist as a member will
<u>not</u> be eligible for the exchange. This is primarily because we would like
to give AO3 time to standardize the protagonist' canonical tags before we
generate our own tags.

**Relationships consisting only of Veilguard companions are eligible.**
...
<img
  ...
  className="thumbnail"
/>
<p class="label">No Canon Tag: click to enlarge</p>
