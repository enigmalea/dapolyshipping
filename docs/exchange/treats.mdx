...
This exchange will have two treatless lists:

1. The AutoAO3 app which we're using for our requests spreadsheet allows a lot
   of cool sorting and filtering tricks. Once someone has received a treat, the
   mods will add an `Additional Tag` which says **Treat Received**.
...
2. Because filtering can sometimes be hit or miss, we will also be posting a
   separate treatless list. The link will be added to the website and shared to
   our tumblr!
...
<img src="/img/posttreat.png" alt="Post Treat" className="thumbnail" />
